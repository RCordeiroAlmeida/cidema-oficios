<?php
    ...
    switch($_SESSION['cidema_userPermissao']){
        ...
        break;            
        case '2': // FUNCIONARIO
            $where = "AND fun_cod = ".$_SESSION['cidema_userFuncionario'];
            $join = "INNER JOIN funcionario AS f ON (s.set_cod = f.set_cod)";   
        break;
        case '3': // CLIENTE
            $where = "AND c.cli_cod = ".$_SESSION['cidema_userCliente'];
            $join = "";   
        break;
    }
    ...
    switch($_SESSION['cidema_userPermissao']){
        ...
        case '2': // FUNCIONARIO
            $join = "";
            $where = " AND s.set_cod = ".$_SESSION['cidema_userSetor'];
        break;
        case '3': // CLIENTE
            $where = "AND c.cli_cod = ".$_SESSION['cidema_userCliente'];
            $join = "";   
...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <?php if($_SESSION['cidema_userPermissao'] == 3){?>
