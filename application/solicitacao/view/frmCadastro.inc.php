<?php
if (!isset($_SESSION) && $_SESSION['cidema_userPermissao'] == 2) {
...
$sql = "SELECT cli_nome, cli_cod FROM cliente WHERE cli_cod = " . $_SESSION['cidema_userCliente'];
$res_entidade = $data->find('dynamic', $sql);
            ...
            <form role="form" action="?module=solicitacao&acao=grava_solicitacao" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                ...
                <div class="row form-group">
                    ...
                    <div style="visibility: hidden; width:0; height: 0;">
                        ...
                        <input name="cli_cod" type="text" class="form-control blockenter" id="cli_cod" value="<?php echo $res_entidade[0]['cli_cod'] ?>" readonly></input>
                    </div>

                    <div class="col-sm-10">
                        <label class="control-label" for="cli_nome">Cliente:</label>
                        <input type="text" class="form-control blockenter" id="cli_nome" value="<?php echo $res_entidade[0]['cli_nome'] ?>" disabled></input>
                    </div>
                </div>
