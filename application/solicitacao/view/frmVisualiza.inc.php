...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="col-lg-3 col-xs-4" style="text-align:right;">
        <br /><br />
        <?php
            if ($_SESSION['cidema_userPermissao']!=3){
                                                        ...
                                                        for ($i = 0; $i < count($atividade); $i++) {
                                                            ...
                                                            echo '
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="#" onClick="busca_atividade('<?php echo $atividade[$i]['ati_cod'] ?>', '<?php echo $_SESSION['cidema_userId'] ?>', '<?php echo $_SESSION['cidema_userPermissao'] ?>')" data-toggle='modal' data-target='#detalheAtividade' class="btn btn-primary" style="height: 34px;">
