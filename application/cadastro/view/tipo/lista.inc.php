<?php
    ...
    $sql = "SELECT * FROM documento_tipo WHERE dtp_situacao = 1 ORDER BY dtp_descricao";
    $ati = $data->find('dynamic', $sql);

    $sql = "SELECT * FROM documento_tipo WHERE dtp_situacao = 0 ORDER BY dtp_descricao";
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < count($ati); $i++) {
                                            echo '
                                            <tr>
                                                <td>' . str_pad($ati[$i]['dtp_cod'], 4, '0', STR_PAD_LEFT) . '</td>
                                                <td>' . $ati[$i]['dtp_descricao'] . '</td>
                                                <td>';
                                                    if($_SESSION['cidema_userPermissao']==1){
                                                        echo'
                                                            <a href="#" onclick="nextPage(\'?module=cadastro&acao=edita_tipo\', ' . $ati[$i]['dtp_cod'] . ')">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>
                                                                <i class="fa fa-pencil fa-stack-1x fa-inverse"></i>
                                                            </span>
                                                            </a>
                                                            <a href="#" onClick=\'inativar("' . $ati[$i]['dtp_cod'] . '", "' . $ati[$i]['dtp_descricao'] . '");\' title="Inativar Tipo de Documento" style="text-decoration:none;">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>
                                ...
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        for ($i = 0; $i < count($ina); $i++) {
                                            echo '
                                            <tr>
                                                <td>' . str_pad($ina[$i]['dtp_cod'], 4, '0', STR_PAD_LEFT) . '</td>
                                            ...
                                            if($_SESSION['cidema_userPermissao'] == 1){
                                                ...
                                                echo'
                                                    <td>
                                                        <a href="#" onClick=\'ativar("' . $ina[$i]['dtp_cod'] . '", "' . $ina[$i]['dtp_descricao'] . '");\' title="Ativar Tipo de Documento" style="text-decoration:none;">
                                                            <span class="fa-stack">
                                                                <i class="fa fa-square fa-stack-2x"></i>
