...
?>
<body onload="validapermissao(<?php echo $_SESSION['cidema_userPermissao']; ?>);">
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <form role="form" action="?module=cadastro&acao=update_entidade" id="MyForm" method="post" enctype="multipart/form-data" name="MyForm">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input name="ent_nome" type="text" class="form-control blockenter" id="ent_nome" value="<?php echo $result[0]['ent_nome']; ?>" style="text-transform:uppercase;" required />
                    </div>

                    <div class="col-sm-6">
                        <label class="control-label" for="ent_mail">E-mail:</label>
                        <input name="ent_mail" type="text" class="form-control blockenter" id="ent_mail" value="<?php echo $result[0]['ent_mail']; ?>" required />
                    </div>
                </div>
                ...
                <div class="row form-group">
                    <div class="col-sm-2">
                        ...
                        <input name="ent_cnpj" type="text" class="form-control blockenter" id="ent_cnpj" value="<?php echo $result[0]['ent_cnpj']; ?>" required />
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-6">
                        <label class="control-label" for="ent_endereco">Endereço:</label>
                        <input name="ent_endereco" type="text" class="form-control blockenter" id="ent_endereco" value="<?php echo $result[0]['ent_endereco']; ?>" required />
                    </div>
                </div>
            </form>
        </div>
