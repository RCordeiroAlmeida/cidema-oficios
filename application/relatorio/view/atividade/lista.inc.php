...
<form role="form" action="application/relatorio/view/atividade/relatorio.php " target="_blank" id="MyForm" method="post" > 
    <input type="hidden" value="<?php echo $_SESSION['cidema_userName']?>" name="usuario"/>
    <input type="hidden" value="<?php echo $_SESSION['cidema_userId']?>" name="userId"/>
    <input type="hidden" value="<?php echo $_SESSION['cidema_userPermissao']?>" name="permissao"/>
            ...
            <div class="ibox-content">
                <div class="row form-group">  
                    <?php if($_SESSION['cidema_userPermissao'] == 1){ ?>
                        ...
                        <?php }else{ ?>
                            <input type="hidden" name="usu_cod" value="<?php echo $_SESSION['cidema_userId']?>">
                        <?php }?>    
                    <div class="col-sm-4" > 
